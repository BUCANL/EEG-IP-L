...
% Brock University Cognitive and Affective Neuroscience Laboratory note
% TODO(brad)
% this section actually prints an error, unfortunatly this error also causes
% a fatal error due to the way they index list, which is a string due to
% what Octave returns from the "which" command
% we modified it to if 0 to just skip this section, we assume that nothing will
% go wrong
