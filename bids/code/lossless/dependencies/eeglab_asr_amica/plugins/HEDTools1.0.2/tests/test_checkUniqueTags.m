...
[errors, tags] = checkUniqueTags(values.Maps, values.Tags1, values.Tags1);
...
[errors, tags] = checkUniqueTags(values.Maps, values.Tags2, values.Tags2);
...
[errors, tags] = checkUniqueTags(values.Maps, values.Tags3, values.Tags3);
assertFalse(isempty(errors));
assertFalse(isempty(tags));
assertEqual(length(tags), 2);