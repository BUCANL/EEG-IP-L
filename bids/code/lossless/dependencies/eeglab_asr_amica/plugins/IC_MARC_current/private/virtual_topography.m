...
% For some reason they passed a [] instead of a 0 (as documented in Matlab)
% but [] acts as 0 so we changed it. Actually this is a compatibility issue
% with Octave that should probably be sent upstream
eeg.virtual_topography = zscore(virtual_topog,0,2);
