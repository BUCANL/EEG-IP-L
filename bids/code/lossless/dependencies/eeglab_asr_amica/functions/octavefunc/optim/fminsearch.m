## Brock University Cognitive and Affective Neuroscience Lab note:
## This file was included from the main development branch of Octave in order
## to support Fieldtrip in the dipfit portion of the pipeline
## It should be included in the pipeline until Octave version >4.4 is available
