% EEG = interp_ref - Read coordinate files and interpolate data to locations
%                    currently loaded in EEGLAB. The average of the interpolated
%                    channels is then calculated and subtracted from each of the
%                    channels in the currently loaded data in EEGLAB.
%                    It is important that the sfp file containing the reference 
%                    channel names and coordinates 1- contains the same fiducials
%                    as the loaded coordinates for the data field and 2- the
%                    channel names of the reference sites do not match any of the
%                    names from the data channels.
%
% Usage:
