...
%
% $Id: ft_dipolefitting.m 9865 2014-09-28 12:33:58Z roboos $

revision = '$Id: ft_dipolefitting.m 9865 2014-09-28 12:33:58Z roboos $';
...
% THE FOLLOWING CODE IS CHANGED FOR DIPFIT'S pop_multifit_bucanl_parallel
% IMPLEMENTATION TO WORK AS OCTAVE NEEDS EXTERNAL STRUCTURES TO BE UNCHANGED
...
if strcmp(cfg.gridsearch, 'yes')
  ...
  for i=1:length(grid.inside)
    ...
    if isfield(grid, 'leadfield')
      ...
      lf = ft_compute_leadfield(grid.pos(indx,:), sens, vol, 'reducerank', cfg.reducerank, 'normalize', cfg.normalize, 'normalizeparam', cfg.normalizeparam, 'backproject', cfg.backproject);
    end
