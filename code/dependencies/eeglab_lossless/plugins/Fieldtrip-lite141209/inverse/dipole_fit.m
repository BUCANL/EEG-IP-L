...
% TODO(brad) NOTE: fminsearch is used here, Octave 4.2.1 does not have
% the required options for this function so we have included it in
% eeglab_asr_amica/functions/octavefunc/optim/
